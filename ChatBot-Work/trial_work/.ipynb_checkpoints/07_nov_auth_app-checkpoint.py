...
with open('/home/ubuntu/workspace/mrwhisper-codespace/ChatBot-Work/web_app/authentication_config_2.yaml') as file:
...
if authentication_status:
    ...
    #st.title('RunningMemory ChatBot')
    ...
    if prompt: 
        ...
        answer = main_chat_with_google_fn(prompt,pinecone_index,chat_summary)
