...
def running_summarize(chat_history, new_query):
    ...
    message = [
            ...
            ******** DO INCLUDE IN PROVIDED/CORRECTED/REQUIRED CODE OR CONFIG - AND BE LESS VERBOSE, FOCUS ON IMPORTANT THINGS ONLY *********:: 
...
def return_docs_from_pinecone_lang( query,pinecone_index, embeddings =embeddings):
